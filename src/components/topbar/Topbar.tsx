...
const Topbar: FC<TopbarProps> = ({ bgColor }) => {
  const { replace, asPath, locale, pathname } = useRouter();
      ...
      <Container
        ...
        <FlexBox className="topbarLeft" alignItems="center">
          ...
          <FlexBox alignItems="center" ml={2.5}>
            ...
            <Span className="title">support@topshopes.com</Span>
          </FlexBox>
        </FlexBox>
        ...
        <FlexBox className="topbarRight" alignItems="center">
          ...
          <BazaarMenu
            ...
            {languages.map((item) => (
              <MenuItem className="menuItem" key={item} onClick={handleLanguageClick(item)}>
